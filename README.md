...
- Data para entrega regular do projeto: `24/01/2023 14:00`
...
- `git clone git@github.com:tryber/sd-029-b-project-trybewarts.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-029-b-project-trybewarts`
...
- Verifique se você está na raiz do projeto
  ...
  - Exemplo: `pwd` -> o retorno vai ser algo como _/Users/joao/code/**sd-029-b-project-trybewarts**_
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-029-b-project-trybewarts/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-029-b-project-trybewarts/pulls) e confira que o seu _Pull Request_ está criado
